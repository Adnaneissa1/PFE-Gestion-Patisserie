  ...
  return (
    <div  style={{ backgroundColor:'rgb(236, 255, 255)'}}>
      ...
      <div className='about_img'>
        <div  className='about'>
          <img className='img_about' src={about2} alt='' width={'700px'} />
          <h1  style={{padding:'30px'}}>OUR STORY</h1>
          <p > 
        ...
        <div className='about'>
          <img className='img_about' src={about1} alt=''width={'700px'} /> 
          <h1  style={{padding:'30px'}}>OUR PHILOSOPHY</h1>
          <p > 
